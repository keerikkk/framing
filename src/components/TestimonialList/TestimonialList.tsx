...
const data: TestimonialProps[] = [
  {
    ...
    content:
      'Дуже сподобалося, що студія світла і простора,все необхідне вже було під рукою.',
  },
  {
    header: {
      ...
      author: 'Максим Черненко',
      platform: 'Instagram',
    },
    content:
      'Орендував студію для подкасту — звук, світло і атмосфера були на найвищому рівні.',
  },
  {
    header: {
    ...
    content:
      'Комфортна студія з сучасним обладнанням, однозначно рекомендую для творчих проєктів.',
  },
];
