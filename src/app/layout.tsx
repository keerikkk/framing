...
export const metadata: Metadata = {
  ...
  title: 'Framing - Фотостудія Ужгорода',
  description:
  ...
  openGraph: {
    title: 'Framing - Фотостудіа Ужгорода',
    description:
      'Фотостудія Ужгорода. Портретна, комерційна зйомка. Ми зосереджені на збереженні ваших особливих моментів з високим рівнем професіоналізму.',
    type: 'website',
    locale: 'uk_UA',
    url: baseUrl,
    siteName: 'Framing',
