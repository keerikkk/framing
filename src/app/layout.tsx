...
export const metadata: Metadata = {
  ...
  title: 'Framing - фотостудія Ужгороду',
  description:
  ...
  openGraph: {
    title: 'Framing - фотостудія Ужгороду',
    description:
      'Фотостудія Ужгороду. Портретна, комерційна зйомка. Ми зосереджені на збереженні ваших особливих моментів з високим рівнем професіоналізму.',
    type: 'website',
    locale: 'uk_UA',
    url: baseUrl,
    siteName: 'Framing',
